...
/**
 * ProductBatch Data Access Object (DAO).
 * This class contains all database handling that is needed to 
 * permanently store and retrieve ProductBatch object instances. 
 */
...
public class ProductBatchDAO {
     ...
     */
    public ProductBatch createValueObject() {
    ...
    public ProductBatch getObject(Connection conn, int prodBatchId) throws NotFoundException, SQLException {
        ...
        ProductBatch valueObject = createValueObject();
        valueObject.setProdBatchId(prodBatchId);
     ...
     */
    public void load(Connection conn, ProductBatch valueObject) throws NotFoundException, SQLException {
        ...
        try {
            ...
            stmt.setInt(1, valueObject.getProdBatchId());
     ...
     */
    public synchronized void create(Connection conn, ProductBatch valueObject) throws SQLException {
        ...
        try {
            ...
            stmt.setInt(1, valueObject.getProdId());
            stmt.setInt(2, valueObject.getRawMatBatchId());
        ...
        try {
            ...
            if (result.next()) {
                ...
                valueObject.setProdBatchId((int) result.getLong(1));
     ...
     *                    Primary-key field must be set for this to work properly.
     */
    public void save(Connection conn, ProductBatch valueObject) throws NotFoundException, SQLException {
        ...
        try {
            ...
            stmt.setInt(4, valueObject.getProdBatchId());
     ...
     *                    Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, ProductBatch valueObject) throws NotFoundException, SQLException {
     ...
     */
    public List searchMatching(Connection conn, ProductBatch valueObject) throws SQLException {
        ...
        if (valueObject.getProdBatchId() != 0) {
            if (first) {
                first = false;
            }
            sql.append("AND prodBatchId = ").append(valueObject.getProdBatchId()).append(" ");
        }

        if (valueObject.getProdId() != 0) {
            if (first) {
                first = false;
            }
            sql.append("AND prodId = ").append(valueObject.getProdId()).append(" ");
        }

        if (valueObject.getRawMatBatchId() != 0) {
            if (first) {
                first = false;
            }
            sql.append("AND rawMatBatchId = ").append(valueObject.getRawMatBatchId()).append(" ");
        }
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, ProductBatch valueObject)
        ...
        try {
            ...
            if (result.next()) {
                ...
                valueObject.setProdBatchId(result.getInt("prodBatchId"));
                valueObject.setProdId(result.getInt("prodId"));
                valueObject.setRawMatBatchId(result.getInt("rawMatBatchId"));
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
        ...
        try {
            ...
            while (result.next()) {
                ProductBatch temp = createValueObject();
