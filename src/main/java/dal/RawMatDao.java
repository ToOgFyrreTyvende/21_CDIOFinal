...
import java.math.*;
 ...
 /**
  * RawMat Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve RawMat object instances. 
  */
...
public class RawMatDao {
     ...
     * clone() method in it!
     */
    public RawMat createValueObject() {
          return new RawMat();
    }
    ...
    public RawMat getObject(Connection conn, int rawMatID) throws NotFoundException, SQLException {
          ...
          RawMat valueObject = createValueObject();
          valueObject.setRawMatID(rawMatID);
     ...
     */
    public void load(Connection conn, RawMat valueObject) throws NotFoundException, SQLException {
          ...
          try {
               ...
               stmt.setInt(1, valueObject.getRawMatID()); 
     ...
     */
    public synchronized void create(Connection conn, RawMat valueObject) throws SQLException {
          ...
          try {
               ...
               stmt.setInt(1, valueObject.getRawMatID()); 
               stmt.setString(2, valueObject.getRawMatName()); 
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void save(Connection conn, RawMat valueObject) 
          ...
          try {
              stmt = conn.prepareStatement(sql);
              stmt.setString(1, valueObject.getRawMatName()); 
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, RawMat valueObject) 
          throws NotFoundException, SQLException {
     ...
     */
    public List searchMatching(Connection conn, RawMat valueObject) throws SQLException {
          ...
          if (valueObject.getRawMatName() != null) {
              if (first) { first = false; }
              sql.append("AND rawMatName LIKE '").append(valueObject.getRawMatName()).append("%' ");
          }
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, RawMat valueObject) 
          throws NotFoundException, SQLException {
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setRawMatName(result.getString("rawMatName")); 
